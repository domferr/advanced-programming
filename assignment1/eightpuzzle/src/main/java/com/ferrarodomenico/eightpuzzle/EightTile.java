...
public class EightTile extends JButton implements Serializable, PropertyChangeListener {
    ...
    public static final int HOLE_TILE_LABEL = 9;
    ...
    private void refreshTileUI() {
        ...
        switch(this.tileLabel) {
            case -1:
                ...
                break;
            case EightTile.HOLE_TILE_LABEL:
    ...
    private void onClick() {
        ...
        try{
            super.fireVetoableChange(EightTile.TILE_LABEL_PROPERTY, oldValue, EightTile.HOLE_TILE_LABEL);
            
            // update tile value since there is no veto
            this.setTileLabel(EightTile.HOLE_TILE_LABEL);
